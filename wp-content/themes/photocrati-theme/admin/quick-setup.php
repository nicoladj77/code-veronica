            ...
            <div class="option-content">
                ...
                <div id="option-container">
					...
					*To add and edit blog posts, click <a href="edit.php">Posts</a> on the left. Click the name of a post or click Add New. Add a title, content or images. You can also add galleries to your posts by clicking New Photocrati Gallery. Click publish and the new post will appear on your blog.
					...
					<p><strong>PHOTOCRATI THEME OPTIONS.</strong> All the options for customizing your Photocrati Theme, including your theme style, colors, fonts, spacing, gallery settings, and ecommerce settings, are found under the <a href="admin.php?page=customize-theme">Theme Options</a> tab on the left. </p>

...
jQuery(document).ready(function()
{
	...
	if(jQuery(this).is(':checked')) {
        ...
        <input type="image" src="<?php bloginfo('template_url'); ?>/admin/images/gallery_nexgen_import.jpg" id="import_nexgen_images" value="Import From NexGen" onclick="return false;" /> 
        <input type="image" src="<?php bloginfo('template_url'); ?>/admin/images/gallery_nexgen_cancel.jpg" id="cancel_nexgen" value="Cancel Import" onclick="return false;" />   

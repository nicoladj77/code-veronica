...
jQuery(document).ready(function()
{
    ...
    jQuery('[id^=edit_button_]').click(function(){
	...
	foreach ($gallery as $gallery) {
		...
		if($gallery->gal_type == '6' || $gallery->gal_type == '7') {
			...
			if($gallery->gal_type == '6') {
				...
				echo '<div style="float:left;width:140px;"><img src="'.get_bloginfo('template_url').'/admin/images/album_list.jpg"></div>';
				
			} else {
				
				echo '<div style="float:left;width:140px;"><img src="'.get_bloginfo('template_url').'/admin/images/album_grid.jpg"></div>';
...
jQuery(document).ready(function()
{
    ...
    jQuery('#delete_button_<?php echo $gallery->gallery_id; ?>').click(function(){
		...
		jQuery.ajax({type: "POST", url: "<?php echo get_bloginfo('template_url'); ?>/admin/gallery/delete-gallery.php", data: 'gallery_id=<?php echo $gallery->gallery_id; ?>&post_id=<?php echo $gallery->post_id; ?>', success: function(data)
			{
				jQuery.ajax({type: "POST", url: "<?php echo get_bloginfo('template_url'); ?>/admin/gallery/get_galleries.php", data: 'post_id=<?php echo $_POST['post_id']; ?>', success: function(data)
				{
    ...
    jQuery('#delete_abutton_<?php echo $gallery->gallery_id; ?>').click(function(){
		...
		jQuery.ajax({type: "POST", url: "<?php echo get_bloginfo('template_url'); ?>/admin/gallery/delete-album.php", data: 'gallery_id=<?php echo $gallery->gallery_id; ?>&post_id=<?php echo $gallery->post_id; ?>', success: function(data)
			{
				jQuery.ajax({type: "POST", url: "<?php echo get_bloginfo('template_url'); ?>/admin/gallery/get_galleries.php", data: 'post_id=<?php echo $_POST['post_id']; ?>', success: function(data)
				{
                    if (tinyMCE.activeEditor != null && tinyMCE.activeEditor.isHidden() == false) {
	...
	jQuery('#reinsert_button_<?php echo $gallery->gallery_id; ?>').click(function(){
        ...
        if (tinyMCE.activeEditor != null && tinyMCE.activeEditor.isHidden() == false) {
			...
			<?php if($gallery->gal_type == '6' || $gallery->gal_type == '7') { ?>
				...
				tinyMCE.execCommand('mceInsertContent',false,'<img id="phgallery-<?php echo $gallery->gallery_id.' '.$gallery->gal_type; ?>" src="<?php bloginfo('template_url'); ?>/admin/images/album-placeholder-<?php echo $galnumber[1]; ?>.gif" alt="photocrati gallery" />');
				
			<?php } else { ?>
				
				tinyMCE.execCommand('mceInsertContent',false,'<img id="phgallery-<?php echo $gallery->gallery_id.' '.$gallery->gal_type; ?>" src="<?php bloginfo('template_url'); ?>/admin/images/gallery-placeholder-<?php echo $galnumber[1]; ?>.gif" alt="photocrati gallery" />');
			...
			<?php if($gallery->gal_type == '6' || $gallery->gal_type == '7') { ?>
				...
				insertInPost('<img id="phgallery-<?php echo $gallery->gallery_id.' '.$gallery->gal_type; ?>" src="<?php bloginfo('template_url'); ?>/admin/images/album-placeholder-<?php echo $galnumber[1]; ?>.gif" alt="photocrati gallery" />');
				
			<?php } else { ?>
				
				insertInPost('<img id="phgallery-<?php echo $gallery->gallery_id.' '.$gallery->gal_type; ?>" src="<?php bloginfo('template_url'); ?>/admin/images/gallery-placeholder-<?php echo $galnumber[1]; ?>.gif" alt="photocrati gallery" />');
...
<?php
		...
		if($gallery->gal_type == '6' || $gallery->gal_type == '7') {
			...
			echo '<p><div style="float:left;"><a href="'.get_bloginfo('template_url').'/admin/gallery/upload_edit.php?post='.$gallery->post_id.'&gallery_id='.$gallery->gallery_id.'&TB_iframe=true" class="thickbox"><img src="'.get_bloginfo('template_url').'/admin/images/edit_album.jpg" id="edit_button_'.$gallery->gallery_id.'" /></a></div>';
			echo '<div style="float:left;"><img src="'.get_bloginfo('template_url').'/admin/images/delete_album.jpg" id="delete_abutton_'.$gallery->gallery_id.'" style="cursor:pointer;margin:0 4px;" /></div>';
			echo '<div style="float:left;"><img src="'.get_bloginfo('template_url').'/admin/images/reinsert_album.jpg" id="reinsert_button_'.$gallery->gallery_id.'" style="cursor:pointer;margin:0 4px;display:none;" /></div>';
			...
			echo '<p><div style="float:left;"><a href="'.get_bloginfo('template_url').'/admin/gallery/upload_edit.php?post='.$gallery->post_id.'&gallery_id='.$gallery->gallery_id.'&TB_iframe=true" class="thickbox"><img src="'.get_bloginfo('template_url').'/admin/images/edit_gallery.jpg" id="edit_button_'.$gallery->gallery_id.'" /></a></div>';
			echo '<div style="float:left;"><img src="'.get_bloginfo('template_url').'/admin/images/delete_gallery.jpg" id="delete_button_'.$gallery->gallery_id.'" style="cursor:pointer;margin:0 4px;" /></div>';
			echo '<div style="float:left;"><img src="'.get_bloginfo('template_url').'/admin/images/reinsert_gallery.jpg" id="reinsert_button_'.$gallery->gallery_id.'" style="cursor:pointer;margin:0 4px;display:none;" /></div>';
			echo '<div class="msggallery1" id="msggallery_'.$gallery->gallery_id.'"></div></p>';

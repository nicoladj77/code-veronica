...
jQuery(document).ready(function() {
	...
	jQuery('[id^=ecomm_cost]').keyup(function (event) { 
                ...
                <div id="option-container">
                	...
                	<div class="left" style="width:99%">
						...
						<div class="inner" style="width:42%">
                            ...
                            <p>
							<input type="text" name="pp_account" id="pp_acount" value="<?php echo $pp_account; ?>" size="45" />
							</p>
                        </div>
                	...
                	<div class="left" style="width:99%">
						...
						<div class="inner" style="width:60%">
                            ...
                            <p>
							<input type="text" name="pp_return" id="pp_return" value="<?php echo $pp_return; ?>" size="65" />
							</p>
                        </div>
                ...
                <div id="option-container">
                    ...
                    <div class="left" style="width:99%;">
						...
						<div class="inner" style="width:99%;">
                            ...
                            <p class="notes">
                                <b>Note: </b><i>You can have up to 20 available print size options. These are global settings for all galleries
                	...
                	<div class="left" style="width:48%;float:left;clear:none;">
						
						<div class="inner" style="width:72%;margin-bottom:-10px;">
                            <p class="titles">Option <?php echo $l; ?></p>
                            <p>
							<input type="text" name="ecomm_op<?php echo $l; ?>" id="ecomm_op<?php echo $l; ?>" value="<?php echo ${"ecomm_op$l"}; ?>" size="39" />
							</p>
                        </div>
						
						<div class="inner" style="width:27%;margin-bottom:-10px;">
                            <p class="titles">Price <?php echo $l; ?></p>
                            <p>
							<input type="text" name="ecomm_cost<?php echo $l; ?>" id="ecomm_cost<?php echo $l; ?>" value="<?php echo ${"ecomm_cost$l"}; ?>" size="6" />
							</p>
                        </div>
					...
					<div class="left" style="width:99%;height:20px;"></div>		  
